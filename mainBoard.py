...
class BoardInit:
    def __init__(self):
        ...
        mainShip = shipClass.Ship(direct = [0,1], speed = [0,0], pos = [500,500])
        ...
        shiprect = shiprect.move(mainShip.pos)
        while 1:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    mainShip.speed[0] -= int(mainShip.direct[0] * 10)
                    mainShip.speed[1] -= int(mainShip.direct[1] * 10)
